    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Binary Tech Consultancy</h1>
          <h2>We are team of talented designers making websites.</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#about" class="btn-get-started scrollto">Get Started</a>
            <a href="https://drive.google.com/file/d/1dlIc85g4wOgaVC-uWmvBuf9wkQnebH6n/preview" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
          </div>
        </div>
...
<section id="course" class="about">
      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
            ...
            <div class="content">
              <h3>WHY <strong>Binary Tech Consultancy?</strong></h3>
              <p>
                Binary Tech Consultancy iS a IT sector company.Which provide a best solution for your Internet World.
              </p>
            </div>
            ...
            <div class="accordion-list">
              <ul>
                <li>
                  <a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"><span>01</span> Why? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list">
                    <p>
                      Because it provide you best website and apps in very best price.
                    </p>
                  </div>
                </li>

                <li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed"><span>02</span> Who?  <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  <div id="accordion-list-2" class="collapse" data-bs-parent=".accordion-list">
                    <p>
                      It is start up company so it enhancing the business growth of our customers with creative Design and Development to deliver market-defining high-quality solutions
                    </p>
                  </div>
                </li>

                <li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-3" class="collapsed"><span>03</span>How? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
            <h3>Our Services</h3>
            <p class="fst-italic">
              Binary Tech Consultancy Provide Best Online Services.
            </p>
            ...
            <div class="skills-content">
              ...
              <div class="progress">
                <span class="skill">Android Development <i class="val">100%</i></span>
                <div class="progress-bar-wrap">
                  <div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">Online Community</a></h4>
              <p>Feel like home, with a "family of invisible friends".
                Only work from home are available.
              </p>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Flexible Curriculum</a></h4>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            ...
            <p> Binary Tech Consultancy gives you better customer support.Learning Together
              From the Comfort
              of Your Home</p>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Portfolio</h2>
          <p>Our Previous Project.</p>
        </div>

        <ul id="portfolio-flters" class="d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
          <li data-filter="*" class="filter-active">All</li>
          <li data-filter=".filter-app">App</li>
          <li data-filter=".filter-card">Internship</li>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="https://img.youtube.com/vi/bxRVz8zklWM/hqdefault.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Anchal Kr. Chaudhary</h4>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
              <div class="pic"><img src="assets/img/team/abinash.PNG" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Abinash Kumar</h4>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              ...
              <ul>
                ...
                <li><i class="bx bx-check"></i> Certificate</li>
                <li><i class="bx bx-check"></i> Reward</li>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="box featured">
              <h3>Stipend Internship</h3>
              <h4><sup>Rs.</sup>500<span>per month</span></h4>
              <ul>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="box">
              <h3>Trainning </h3>
              <h4><sup>Rs.</sup>150<span>only</span></h4>
              <ul>
                <li><i class="bx bx-check"></i> Quam adipiscing vitae proin</li>
                <li><i class="bx bx-check"></i> Nec feugiat nisl pretium</li>
                <li><i class="bx bx-check"></i> Nulla at volutpat diam uteera</li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Email:</strong> noreply@binarytech.com<br>
            </p>
          </div>
