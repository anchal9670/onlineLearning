...
echo "<script>window.location.href = 'Teachboard.php'</script>";
...
if (isset($_POST['submit'])){
  ...
  $user_check_query = "SELECT Id,Email ,Password ,category FROM login WHERE Email='$email'  LIMIT 1";
  ...
  if ($row>0) { // if user exis
    if($user['category']==$category)
    {
      ...
      {   
          ...
          header("Location: Teachboard.php");
      ...
      else
      {
          ...
          echo '</script>';
          echo '<script type ="text/JavaScript">';  
          echo 'window.location.href = "signInAdmin.php";';  
          echo '</script>';
      ...
      {
          echo '<script type ="text/JavaScript">';  
          echo 'alert("You are Not a Teacher")';  
          echo '</script>';
          echo '<script type ="text/JavaScript">';  
          echo 'window.location.href = "signInAdmin.php";';  
          echo '</script>';
    ...
    <section id="Login" class="portfolio-details">
      <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" action="signInAdmin.php" method="POST">
